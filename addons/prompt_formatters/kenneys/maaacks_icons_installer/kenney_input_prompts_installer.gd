...
const RELATIVE_PATH_TO_CONFIGURE_SCENE = "../input_icon_mapper.tscn"
...
func _configure_icons() -> void:
	var input_options_menu_path: String = get_script().resource_path.get_base_dir() + "/" + RELATIVE_PATH_TO_CONFIGURE_SCENE
